// $ANTLR 2.7.6 (2005-12-22): "expr.g" -> "ExprLexer.java"$
...
tryAgain:
	...
	public final void mIMPL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = IMPL;
		int _saveIndex;
	...
	public final void mSEM(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = SEM;
		int _saveIndex;
