...
public class ClassFile extends AbstractClassFile
{
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            /*
                             * let the handler with the handler closer to 0 win
                             */
                            return -1;
                        }
    ...
    protected class MethodRenderer extends AbstractMethodRenderer
    {
        ...
        public MethodRenderer(int access, String name, String descriptor, String signature, String[] exceptions)
        {
        ...
        {
            return new LocalVariableTable(ClassFile.this.constantPool, available);
        }
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        cr.accept(new ClassFile(null), DEFAULT_ATTRIBUTES, flags);
    }

    public static ClassFile readClass(InputStream in) throws IOException
    {
        ClassFile doc = new ClassFile();
        ClassReader cr = new ClassReader(in, doc);
        cr.accept(doc, AbstractClassFile.DEFAULT_ATTRIBUTES, 0);
        return doc;
    }
     ...
     * @see ClassVisitor
     */
    public ClassFile(ClassVisitor classVisitor)
    {
        // this.pw = pw;
    ...
    public void visitInnerClass(final String name, final String outerName, final String innerName, final int access)
    {
        ...
        {
            /*
             * only show as inner class if the name of thisClass is unequal with name
             */
            appendNewline();
            appendCommentBegin();
            appendSpace();
